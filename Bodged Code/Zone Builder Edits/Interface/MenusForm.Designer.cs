namespace CodeImp.DoomBuilder.BuilderModes
{
	partial class MenusForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStripMenuItem6.Tag = "exportthings";
			this.toolStripMenuItem6.Text = "Map Things";
			this.toolStripMenuItem6.Click += new System.EventHandler(this.InvokeTaggedAction);
			// 
			// editmenuitem
			// 
